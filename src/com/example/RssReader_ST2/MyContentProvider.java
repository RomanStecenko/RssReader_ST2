...
//    public static final String DATABASE_NAME = "FeedReader.db";
    public static final String AUTHORITY = "com.example.RssReader_ST2"; //.my_database_provider
    ...
    public boolean onCreate() {
        Log.d(log, "class MyContentProvider onCreate()");
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        Log.d(log, "class MyContentProvider query(), " + uri.toString());
        switch (uriMatcher.match(uri)) {
            case URI_CONTACTS:
                Log.d(log, "class MyContentProvider query(), URI_CONTACTS");
                break;
    ...
    public String getType(Uri uri) {
        Log.d(log, "class MyContentProvider getType(), " + uri.toString());
        switch (uriMatcher.match(uri)) {
            case URI_CONTACTS:
                return CONTENT_TYPE;
            case URI_CONTACTS_ID:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        Log.d(log, "class MyContentProvider insert(), " + uri.toString());
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        Log.d(log, "class MyContentProvider delete(), " + uri.toString());
        switch (uriMatcher.match(uri)) {
            case URI_CONTACTS:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        Log.d(log, "class MyContentProvider update(), " + uri.toString());
        switch (uriMatcher.match(uri)){
            case URI_CONTACTS:
                Log.d(log, "URI_CONTACTS" );
                break;
